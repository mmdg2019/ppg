...
class AccountMove(models.Model):
    ...
    # calculate invoice due dates: modified to be compatible with Odoo V19
        ...
        for move in self:
            ...
            for line in self.env['account.move.line'].search(domain):
                ...
                payments_widget_vals['content'].append({
                    'journal_name': line.move_id.name or line.ref, # updated only this line to always show invoice no., not SO no.
                    'amount': amount,
