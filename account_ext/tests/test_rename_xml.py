...
class TestMoveXmlidsFromUpgrade16ToAccountExt(UpgradeCase):
    """
    Test that XMLIDs are renamed from ppg_upgrade16.* to account_ext.*
    ...
    def prepare(self):
        ...
        # Force module to look older so migrations will run on `-u account_ext`
        cr.execute(
            """
        ...
        # We assume the NEW xmlids exist because account_ext is installed once before tests.
        # We will:
        #  - locate account_ext.<name>
