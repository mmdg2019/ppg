...
class TestMoveXmlidsFromUpgrade16ToPurchaseExt(UpgradeCase):
    """
    Test that XMLIDs are renamed from ppg_upgrade16.* to purchase_ext.*
    ...
    def prepare(self):
        ...
        # Force module to look older so migrations will run on `-u purchase_ext`
        cr.execute(
            """
