...
class TestMoveXmlidsFromUpgrade16ToSaleExt(UpgradeCase):
    """
    Test that XMLIDs are renamed from ppg_upgrade16.* to sale_ext.*
    ...
    def prepare(self):
        ...
        # Force module to look older so migrations will run on `-u sale_ext`
        cr.execute(
            """
