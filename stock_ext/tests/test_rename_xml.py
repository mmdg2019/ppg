...
class TestMoveXmlidsFromUpgrade16ToStockExt(UpgradeCase):
    """
    Test that XMLIDs are renamed from ppg_upgrade16.* to stock_ext.*
    ...
    def prepare(self):
        ...
        # Force module to look older so migrations will run on `-u stock_ext`
        cr.execute(
            """
